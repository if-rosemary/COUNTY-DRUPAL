...
class TelephoneCleaveWidget extends TelephoneDefaultWidget {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['country'] = [
      ...
      '#description' => $this->t('Enter the two character country code to format the telephone number.'),
    ];
    return $element;
  }
  ...
  public function settingsSummary() {
    ...
    if (!empty($country)) {
      $summary[] = $this->t('Country: @country', ['@country' => $country]);
    }
    else {
      $summary[] = $this->t('No country entered');
    }
